...
> ⚠ 下表是 **2026-09-15 的旧构建**，仅供参考。
> `crop_scale` 改按比例分配后 LUT 有大幅上升，
> **最终数字见下方「最终资源占用」**。
...
| 资源 | 用量 | 占比 | 对比旧版 |
|---|---|---|---|
| Slice LUTs | **24,442** | **45.94%** | ↑ 旧版 11,255 (21.16%) |
| Slice Registers | **30,692** | **28.85%** | ↑ 旧版 14,810 (13.92%) |
| Block RAM Tile | 25.5 | 18.21% | — 不变 |
| DSPs | 61 | 27.73% |
| Bonded IOB | 35 | 28.00% |
