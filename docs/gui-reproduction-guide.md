...
> ⚠ **下面这组是 2026-09-15 的旧构建数字**，仅供参考。
> `crop_scale` 改按比例分配后有较大变化 ——
> 最新为 **LUT 45.94% / FF 28.85% / BRAM 18.21% / DSP 27.73%**
> （见 `vivado/build-report.md`）。
>
> 旧构建：LUT 24.11% / FF 14.86% / BRAM 18.21% / **DSP 27.73%**。
